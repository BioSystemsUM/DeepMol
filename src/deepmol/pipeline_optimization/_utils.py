...
def preset_deepchem_models(trial, data: Dataset) -> list:
    ...
    if model_steps == "gat_model":
        ...
        attentive_fp_kwargs = {'n_tasks': n_tasks, 'mode': mode}
        ...
        patgn_kwargs = {'n_tasks': n_tasks, 'mode': mode}
        ...
        mpnn_kwargs = {'n_tasks': n_tasks, 'mode': mode}
        ...
        megnet_kwargs = {'n_tasks': n_tasks, 'mode': mode}
        ...
        chem_ception_kwargs = {'n_tasks': n_tasks, 'mode': mode}
        ...
        smiles_to_vec_kwargs = {'n_tasks': n_tasks, 'mode': mode}
        ...
        weave_kwargs = {'n_tasks': n_tasks, 'mode': mode}
        ...
        dmpnn_kwargs = {'n_tasks': n_tasks, 'mode': mode, 'n_classes': 2}
