...
def get_featurizer(model_name):
    featurizers_dict = {'GraphConv': deepChemFeaturizers.ConvMolFeat(),
                        ...
                        'Mol2vec': mol2vec.Mol2Vec(pretrain_model_path='/home/src/threed_descriptors_evaluation/model_300dim.pkl'),
...
def read_and_featurize_datasets(train_dataset_path, test_dataset_path, featurizers):
    loader = SDFLoader("/home/src/threed_descriptors_evaluation/data/" + train_dataset_path, labels_fields='_y')
    train_dataset = loader.create_dataset()

    loader = SDFLoader("/home/src/threed_descriptors_evaluation/data/" + test_dataset_path, labels_fields='_y')
...
def train_models_and_evaluate(train_dataset, test_dataset, params_dict, mode, model_name, dataset_name):
    from threed_descriptors_evaluation.model_build_functions import BUILDERS
    ...
    output_filepath = "/home/src/threed_descriptors_evaluation/results_%s.csv" % dataset_name.replace(".sdf", "")
...
with open('/home/src/threed_descriptors_evaluation/pipeline.yml') as f:
